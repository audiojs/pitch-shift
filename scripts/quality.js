...
const algorithms = [
  ...
  { name: 'ola',         fn: ola,         bounds: { loudLo: 0.70, loudHi: 1.30, dur: 0.05, pitch:   -1, f0Err:  60, thd:  5, alias: 1.30, strCorr: 0.80, cent: 0.20, onset: 0.70, attack: 0.90, form: 6.0, phase: 0.80, shift: 3.00, pkErr:   -1, hopAM:    -1 } },
  ...
  { name: 'psola',       fn: psola,       bounds: { loudLo: 0.70, loudHi: 1.30, dur: 0.05, pitch: 0.20, f0Err:   3, thd:  3, alias: 0.85, strCorr:   -1, cent: 0.30, onset: 0.02, attack: 0.90, form: 3.5, phase:   -1, shift: 1.80, pkErr:  2.0, hopAM: 0.030 } },
  { name: 'wsola',       fn: wsola,       bounds: { loudLo: 0.70, loudHi: 1.30, dur: 0.05, pitch: 0.20, f0Err:   5, thd:  3, alias: 0.85, strCorr: 0.20, cent: 0.10, onset: 0.02, attack: 0.95, form: 3.5, phase: 0.85, shift: 1.80, pkErr:  3.0, hopAM: 0.030 } },
  { name: 'granular',    fn: granular,    bounds: { loudLo: 0.70, loudHi: 1.30, dur: 0.05, pitch:   -1, f0Err:  60, thd:  1, alias: 0.80, strCorr: 0.95, cent: 0.20, onset: 0.90, attack: 0.93, form: 4.2, phase: 0.80, shift: 2.50, pkErr:   -1, hopAM:    -1 } },
  ...
  { name: 'paulstretch', fn: paulstretch, bounds: { loudLo: 0.55, loudHi: 1.30, dur: 0.05, pitch:   -1, f0Err:  10, thd:  2, alias: 0.35, strCorr:   -1, cent: 0.12, onset: 0.02, attack: 0.92, form: 8.0, phase:   -1, shift: 2.30, pkErr:   -1, hopAM:    -1 } },
  ...
  { name: 'sample',      fn: sample,      bounds: { loudLo: 0.70, loudHi: 1.30, dur: 0.05, pitch: 0.20, f0Err:   2, thd:  1, alias: 1.10, strCorr: 0.95, cent: 0.05, onset: 0.02, attack: 0.90, form: 3.2, phase:   -1, shift: 2.00, pkErr:  2.0, hopAM: 0.030 } },
